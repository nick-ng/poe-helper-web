...
export const SPEED_NAMES_STORE = "SPEED_NAMES_STORE_POE_WEB";
export const GEM_PLANNER_STORE = "GEM_PLANNER_STORE_POE_WEB";
export const POE_RACING_CHARACTERS_STORE =
  "POE_RACING_CHARACTERS_STORE_POE_WEB";
export const POE_RACING_LEAGUE_STORE = "POE_RACING_LEAGUE_STORE_POE_WEB";
export const POE_RACING_SIZE_STORE = "POE_RACING_SIZE_STORE_POE_WEB";
